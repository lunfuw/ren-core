...
import com.ren.core.common.desensitization.EncryptTransaction;
import com.ren.core.common.desensitization.SensitiveData;
import com.ren.core.common.desensitization.utils.DBAESUtil;
import com.ren.core.common.desensitization.utils.IEncryptUtil;
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        if (parameterObject != null) {
            ...
            if (Objects.nonNull(sensitiveData)) {
                ...
                this.encryptUtil.encrypt(declaredFields, parameterObject);
            }
            // 对普通字段进行加密
